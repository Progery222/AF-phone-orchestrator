...
replace github.com/mobilefarm/af/contacts-manager => ../AF-contacts-manager

replace github.com/mobilefarm/af/video-generator => ../AF-video-generator
