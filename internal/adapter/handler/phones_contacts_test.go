...
func newPhonesHTTPWithContacts(contacts port.ContactsClient) *handler.PhonesHTTP {
	...
	return handler.NewPhonesHTTP(phones, orch, driver.NewStubConnector(), nil, nil, driver.NewStubContent(), contacts, driver.NewStubVideo(), driver.NewStubScenarios(), nil)
}
